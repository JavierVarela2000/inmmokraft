...
const Logo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<a href="/" class="flex items-center gap-2" data-svelte-h="svelte-y79zeh"><img class="h-12" src="/iconos/Logo-blanco-transparente.png" alt="logo"> <div class="text-white relative"><span class="text-xs absolute -top-2 left-1">Consorcio</span> <h1 class="font-bold">inmmokraft</h1> <span class="absolute top-4 text-[10px] right-0">Cía.ltda.</span></div></a>`;
});
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` <nav${add_attribute(
    "class",
    ` p-4 flex items-center justify-between fixed w-full  transition-padding  duration-500 z-[9999] ${$page.url.pathname != "/" ? "py-1 bg-blue-dark shadow-md" : ""}`,
    0
  )}>${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})}  <button class="cursor-pointer w-8 lg:hidden" data-svelte-h="svelte-19p6nh4"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z" fill="#ffffff"></path></svg></button> ${``} <ul class="text-white hidden lg:flex">${each(routes, ({ href, name }) => {
    return `<li class="flex items-center"><a class="inline-block p-2 hover:border-b text-sm"${add_attribute("href", href, 0)}>${escape(name)}</a> </li>`;
  })}</ul></nav>`;
});
