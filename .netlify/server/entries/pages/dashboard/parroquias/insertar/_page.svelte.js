      ...
      default: () => {
        return `<div class="relative w-full mt-3">${validate_component(Input, "Input").$$render(
          ...
          default: () => {
            return `Cantones
              ...
              $$result,
              {
                ...
                placeholder: "Elige una provincia...",
                items: cantones,
                value: parroquia.id_canton
              },
              {
                value: ($$value) => {
                  parroquia.id_canton = $$value;
                  $$settled = false;
                }
              },
              {}
          ...
          $$result,
          {
            ...
            class: "rounded-none peer",
            placeholder: "Latitud...",
            value: parroquia.latitud
          },
          {
            value: ($$value) => {
              parroquia.latitud = $$value;
              $$settled = false;
            }
          },
          {}
          ...
          $$result,
          {
            ...
            value: parroquia.longitud
          },
          {
            value: ($$value) => {
              parroquia.longitud = $$value;
              $$settled = false;
            }
          },
          {}
