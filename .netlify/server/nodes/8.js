import * as server from '../entries/pages/dashboard/cantones/insertar/_page.server.ts.js';

export const index = 8;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/dashboard/cantones/insertar/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/dashboard/cantones/insertar/+page.server.ts";
